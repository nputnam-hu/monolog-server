...
const notesData = require("../data/demo-notes1");
const draftsData = require("../data/demo-drafts1");
const documentPromptsData = require("../data/demo-documentprompts1");
const documentSuggestionsData = require("../data/demo-documentsuggestions1");

const DEMO_DOCUMENT_DRAFT_NOTES_IDX = 1;
